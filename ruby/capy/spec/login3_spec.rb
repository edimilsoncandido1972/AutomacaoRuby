...
describe 'Login com cadastro', :login3 do 
    ...
    it 'login com sucesso' do  
        ...
        within('#login') do  # dentro do elemento que tem o ID login busque username e password 
    ...
    it 'cadastro com sucesso' do  
        ...
        within('#signup') do  # dentro do elemento que tem o ID login busque username e password 
